...
//         const aiMessage={
//             content: aiMessageContent?aiMessageContent:"Error when trying to get message from the ai",
//             id: uuid(),
//             aiMessage: true,
//         };
...
// module.exports= {registerSocketServer};# It is used to identify the organization that owns the API key.
